...
def abstract():
    ...
    st.write("● Pitch refers to the frequency of the sound, or how high or low it is and is represented with the letters [A, B, C, D, E, F, G], with A being \
    the highest and G being the lowest.")
    st.write("● Octave refers to which set of pitches you use on a piano.")
    st.write("● Offset refers to where the note is located in the piece.")
    st.write("And Chord objects are essentially a container for a set of notes that are played at the same time.")
