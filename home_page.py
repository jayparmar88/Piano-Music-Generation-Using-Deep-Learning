...
def abstract():
    ...
    Note objects contain information about the pitch, octave, and offset of the Note. Pitch refers to the \ 
    frequency of the sound, or how high or low it is and is represented with the letters [A, B, C, D, E, F, G], with A being \
